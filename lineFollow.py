...
motor1.start(50) # set motor1 dc here

motor2 = GPIO.PWM(2,50) # set motor2 pwm frequency here
motor2.start(50) # set motor2 dc here
...
def SensorLoop(Sensor1, Sensor2, Sensor3, waitTime):
  ...
  #      readStartButton()
   #     if start:
            ...
            elif(vals[2] == 1 and vals[0] == 0): # going right
                motors_right()

            elif (vals[0 and 2] == 0 and vals[1] == 1): # going straight
                motors_straight()
